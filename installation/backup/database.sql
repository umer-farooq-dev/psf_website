...
--
-- Host: localhost:8889
-- Generation Time: Feb 17, 2026 at 03:37 AM
...
CREATE TABLE `carts` (
  ...
  `tax_model` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'exclude',
...
CREATE TABLE `orders` (
  ...
  `tax_model` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `order_edit_histories` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `u_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` bigint(20) UNSIGNED NOT NULL,
  `edit_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `edited_user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `edited_user_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_amount` decimal(21,12) NOT NULL DEFAULT '0.000000000000',
  `order_due_amount` decimal(21,12) NOT NULL DEFAULT '0.000000000000',
  `order_due_payment_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'paid or unpaid',
  `order_due_payment_info` json DEFAULT NULL,
  `order_due_payment_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_due_transaction_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_due_payment_note` text COLLATE utf8mb4_unicode_ci,
  `order_return_amount` decimal(21,12) NOT NULL DEFAULT '0.000000000000',
  `order_return_payment_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'pending or returned',
  `order_return_payment_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_return_payment_info` json DEFAULT NULL,
  `order_return_transaction_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_return_payment_note` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `tax` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '0.00',
...
--
-- Indexes for table `order_edit_histories`
--
ALTER TABLE `order_edit_histories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_edit_histories_u_id_unique` (`u_id`),
  ADD KEY `order_edit_histories_order_id_index` (`order_id`),
  ADD KEY `order_edit_histories_edited_user_id_index` (`edited_user_id`),
  ADD KEY `order_edit_histories_order_id_created_at_index` (`order_id`,`created_at`),
  ADD KEY `order_edit_histories_order_due_payment_status_order_id_index` (`order_due_payment_status`,`order_id`);
...
--
-- AUTO_INCREMENT for table `order_edit_histories`
--
ALTER TABLE `order_edit_histories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
