...
@section('content')
    <div class="__inline-58">
        ...
        <div class="container rtl text-align-direction">
            ...
            {{-- PSF: the day-by-day table belongs on the contact page, but only
                 once at least one day has hours — otherwise it renders as seven
                 rows of "Fermé", which reads as broken rather than closed. --}}
            @php($psfHours = psfOpeningHoursSummary() !== '' ? psfOpeningHours() : [])
