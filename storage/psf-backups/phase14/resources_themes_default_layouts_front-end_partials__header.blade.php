                ...
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        @if (psfAboutMenu() && $web_config['business_pages']?->firstWhere('slug', 'about-us'))
                            <li class="nav-item dropdown {{ request()->is('business-page/about-us') ? 'active' : '' }}">
                                <a class="nav-link text-capitalize"
                                   href="{{ route('business-page.view', ['slug' => 'about-us']) }}">{{ translate('about_us') }}</a>
                            </li>
                        @endif

                        @if (psfGalleryMenu())
                            <li class="nav-item dropdown {{ request()->routeIs('psf.gallery.*') ? 'active' : '' }}">
                                <a class="nav-link text-capitalize"
                        ...
                        @if (psfQuoteMenu())
                            <li class="nav-item dropdown {{ request()->routeIs('psf.quote.*') ? 'active' : '' }}">
                                <a class="nav-link text-capitalize"
