                ...
                <div class="p-12 p-sm-20 bg-section rounded">
                    ...
                    <div class="form-group mb-20">
                        ...
                        <textarea name="description" id="category_description" rows="3"
                                  class="form-control"
                                  placeholder="{{ translate('Category_Description') }}">{{ $category->description }}</textarea>
                        <small class="text-muted d-block mt-1">{{ translate('shown_on_the_category_page') }}</small>
                    </div>
