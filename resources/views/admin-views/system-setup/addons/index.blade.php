...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form enctype="multipart/form-data" id="addon-upload-form" action="{{ route('admin.system-setup.addon.upload') }}" method="POST" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" novalidate>
                    @csrf
                                ...
                                <div class="bg-section rounded-8 p-12 p-sm-20">
                                    <div class="file-upload-parent {{ $conditionOne && $conditionTwo ? "" : 'disabled' }}">
                                        <div class="custom-file-upload mb-4">
                                            <input type="file"  data-required-msg="{{ translate('only_zip_file_is_allowed') }}"
                                                   data-max-size="{{ getFileUploadMaxSize(type: 'file') }}"
                                                   accept="{{ getFileUploadFormats( type: 'file', skip:['.pdf', '.doc', '.docx', '.txt']) }}"
                                                    name="file_upload" id="input-file" />
                                            <div class="text-center">
                                                ...
                                                <div class="mb-0 fs-12">
                                                    {{ translate('total_file_size_no_more_than_') . getFileUploadMaxSize(type: 'file').' MB' }}
                                                </div>
