                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                       ...
                                       value="{{ $product->unit_price > 0 ? usdToDefaultCurrency($product->unit_price) : '' }}" class="form-control">
                                <small class="text-muted d-block mt-1">
                                    {{ translate('leave_empty_to_show_contact_us_for_the_price_on_the_website') }}
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="availability" id="availability" class="form-control">
                                    <option value="in_stock" {{ ($product->availability ?? 'in_stock') == 'in_stock' ? 'selected' : '' }}>
                                        {{ translate('In_Stock') }}
                                    </option>
                                    <option value="on_order" {{ ($product->availability ?? '') == 'on_order' ? 'selected' : '' }}>
                                        {{ translate('On_Order') }}
                                    </option>
                                </select>
                            </div>
