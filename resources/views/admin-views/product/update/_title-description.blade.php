<div class="bg-section rounded-10 p-12 p-sm-20">
    ...
    {{-- PSF: short description (single value, not per-language) --}}
    <div class="form-group mt-3 mb-0">
        ...
        <textarea name="short_description" id="short_description" rows="2" maxlength="500"
                  class="form-control" placeholder="{{ translate('Short_Description') }}">{{ $product->short_description }}</textarea>
        <small class="text-muted d-block mt-1">{{ translate('shown_on_product_cards_in_the_listing') }}</small>
    </div>
</div>
