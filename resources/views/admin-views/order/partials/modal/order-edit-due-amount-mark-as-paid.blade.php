<form action="{{ route('admin.orders.customer-due-amount-mark-as-paid') }}" method="post">
    @csrf
    <input type="hidden" name="order_id" value="{{ $order['id'] }}">
    <div class="modal fade" id="markAsPaidModal-{{ $order['id'] }}" tabindex="-1" aria-labelledby="markAsPaidModal" aria-hidden="true">
            ...
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body px-20 py-0 mb-30">
                    <div class="d-flex flex-column align-items-center text-center mb-30">
                        <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/icons/cod.png') }}" width="64"
                             class="aspect-1 mb-20" alt="">
                        <h2 class="modal-title mb-3">{{ translate('Mark_as_Paid') }}?</h2>
                        <div>
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <button type="button" class="btn btn-secondary py-3 w-100"
