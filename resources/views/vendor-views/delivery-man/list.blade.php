                ...
                <div class="d-flex justify-content-between gap-10 flex-wrap align-items-center">
                        ...
                        <form action="{{url()->current()}}" method="GET">
                            <div class="input-group input-group-merge input-group-custom">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                       placeholder="{{translate('search_by_name').','.translate('_contact_info')}}"
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <div class="dropdown">
                            ...
                            <button class="btn {{ !empty(request('sort_by')) ? 'btn--primary' : 'btn-outline--primary' }} h-100"
                                    type="button"
                                    id="exportDropdown"
                                    data-toggle="dropdown"
                                    aria-haspopup="true"
                                    aria-expanded="false">
                                <i class="fi fi-sr-sort-alt lh-1"></i>
                            ...
                            <div class="dropdown-menu dropdown-menu-right rounded mt-1 py-2 w-100 min-w-200"
                                ...
                                <a class="dropdown-item d-flex align-items-center gap-2 px-3 py-2"
                                   href="{{ route('vendor.delivery-man.list', ['sort_by' => 'latest', 'searchValue' => request('searchValue')]) }}">
                                ...
                                <a class="dropdown-item d-flex align-items-center gap-2 px-3 py-2"
                                   href="{{ route('vendor.delivery-man.list', ['sort_by' => 'oldest', 'searchValue' => request('searchValue')]) }}">
                                ...
                                <a class="dropdown-item d-flex align-items-center gap-2 px-3 py-2"
                                   href="{{ route('vendor.delivery-man.list',['sort_by' => 'rating', 'searchValue' => request('searchValue')]) }}">
                            ...
                            <td>
                                <a href="{{ route('vendor.delivery-man.rating', ['id' => $deliveryMan['id']]) }}"
                                   class="badge fz-14 badge-soft-info">
                                    <span>{{ isset($deliveryMan->rating[0]->average) ? number_format($deliveryMan->rating[0]->average, 2, '.', ' ') : 0 }} <i
