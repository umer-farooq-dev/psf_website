...
<div class="alert--container active">
    @if(env('APP_MODE') == 'demo')
        <div class="alert alert--message-2 alert-dismissible fade show" id="demo-reset-warning">
            <img width="28" class="align-self-start" src="{{ dynamicAsset(path: 'public/assets/front-end/img/info-2.png') }}" alt="">
            <div class="w--0">
            ...
            <button type="button" class="btn-close position-relative p-0" data-bs-dismiss="alert" aria-label="{{ translate('close') }}"></button>
        </div>
    @endif
