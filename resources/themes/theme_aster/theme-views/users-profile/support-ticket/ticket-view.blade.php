                    ...
                    <div class="card ov-hidden border-0">
                        <div
                            ...
                            <div class="media flex-wrap gap-3">
                                <div class="avatar avatar-lg rounded-circle">
                                    <img loading="lazy" class="img-fit rounded-circle dark-support aspect-1 max-w-140px" alt=""
                        ...
                        <div class="messaging">
                            ...
                            @if($ticket->status ==  'open')
                                <div class="type_msg">
                                    <form action="{{route('support-ticket.comment',[$ticket['id']])}}" method="post" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" novalidate="novalidate">
                                        @csrf
                                        ...
                                        <textarea class="w-100 custom-height h--5rem" id="msgInputValueTicket"
                                                  name="comment" rows="6"
                                                  data-required-msg="{{ translate('type_something') }}"
                                                  placeholder="{{translate('start_typing').'...'}}" required></textarea>
