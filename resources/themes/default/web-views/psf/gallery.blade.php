...
@section('content')
    <div class="container my-4 rtl text-align-direction">
        ...
        @if (count($items) > 0)
            {{-- .cz-gallery / .gallery-item are the theme's own lightbox hooks:
                 theme.js initialises lightGallery on them, so photos open
                 full-screen (client brief §14) without loading anything extra. --}}
            <div class="row g-3 cz-gallery">
        ...
        @if (psfQuoteMenu())
            <div class="text-center mt-4">
                <a href="{{ route('psf.quote.index') }}" class="btn btn--primary psf-accent-btn">
