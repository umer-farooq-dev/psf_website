@if((!isset($productDetailsMeta) || !$productDetailsMeta) && !isset($blogData))
    ...
    @if(!isset($productDetailsMeta) || !$productDetailsMeta)
        ...
        {{-- PSF: with no panel record for this page, fall back to the
             site-wide default instead of an empty (meaningless) tag. --}}
        <meta name="robots" content="{{ $robots ? implode(', ', $robots) : psfRobotsContent() }}">
    @endif
