        ...
        <div class=" inline_product clickable d-flex justify-content-center">
            ...
            <div class="quick-view">
                ...
                <a class="btn-circle stopPropagation action-product-quick-view" href="javascript:" data-product-id="{{ $product->id }}">
                    ...
                    {{-- PSF: brief §8 — a WhatsApp button on every product --}}
                    <a class="btn-circle stopPropagation psf-card-whatsapp-btn"
                   href="{{ psfProductWhatsappUrl($product) }}" target="_blank" rel="noopener"
                   data-toggle="tooltip"
                   title="{{ psfHasPrice($product) ? translate('Order_on_WhatsApp') : translate('Request_the_price') }}">
                    <i class="fa fa-whatsapp align-middle"></i>
                </a>
            </div>
