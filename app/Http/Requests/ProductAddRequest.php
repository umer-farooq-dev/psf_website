...
class ProductAddRequest extends Request
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            // PSF: price is optional. Blank/0 => "Contactez-nous pour le prix"
    ...
    public function after(): array
    {
        return [
            function (Validator $validator) {
                ...
                // PSF: only compare discount against the price when a price was actually entered
                if ($this['product_type'] == 'physical' && (float)($this['unit_price'] ?? 0) > 0 && $this['unit_price'] <= $this->getDiscountAmount(price: $this['unit_price'] ?? 0, discount: $this['discount'], discountType: $this['discount_type'])) {
                    $validator->errors()->add(
